 ...
 */
public class ChanceStarshipSpeechlet implements Speechlet {
    private static final Logger log = LoggerFactory.getLogger(ChanceStarshipSpeechlet.class);
    ...
    protected Quest getQuest() throws Exception {
        ...
        InputStream is = null;
        try {
            is = ConsolePlayer.class.getClassLoader().getResourceAsStream("chance-starship.xml");
